  ...
  return (
    ...
    >
      {LANDING_HERO_MOBILE_TRUST.map((label) => (
        <li
          key={label}
          className="rounded-full border border-[var(--vision-line)] bg-transparent px-3 py-1.5 text-[11px] font-semibold text-[var(--vision-muted)] lg:bg-[var(--vision-panel-bg)]"
        >
          {label}
        </li>
      ))}
