...
export const CONSTITUTION_V2_SECTIONS = {
  ...
  experience:
    "추상어(특별한 경험, 소중한 순간)보다 운영 맥락(문제, 기준, 실행 순서, 주의사항)을 우선한다.",
...
const CHANNEL_RULES = {
  ...
  smartplace:
    "마켓 공지판 — 업체(사장) 1인칭 저희·매장·안내드립니다. 150~350자. 운영·입고·이벤트·예약·혜택. 고객 후기·방문기·블로그체 금지. 이모지 0~1개.",
  instagram:
    "Hook+짧은 줄바꿈 180~480자. 블로그 장면·감정선을 캡션 리듬으로 변환(요약·설명체 금지). 이모지 2~5개(Hook·마무리·한 줄 포인트). 저장·공감.",
  image:
    "English image prompts only. Concrete scene, brand/region mood. No Korean copy, no text overlay.",
};
