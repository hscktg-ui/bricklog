...
} from "@/lib/auth/phoneDuplicatePolicy";

export const PHONE_ALREADY_REGISTERED_MESSAGE = PHONE_DUPLICATE_BLOCK_MESSAGE;
...
async function scanProfilesForPhone(
  ...
  return (data || []).some((row) => {
    ...
    return profileRowBlocksPhoneSignup(row, signupStrict);
  });
}
