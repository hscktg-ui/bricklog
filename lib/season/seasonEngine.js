...
const EVENT_CALENDAR = [
  ...
  { months: [6], key: "rainy", label: "장마·초여름", tags: ["장마", "초여름", "시원한"] },
  { months: [7], key: "peak_summer", label: "휴가철·무더위", tags: ["여름휴가", "무더위", "피크닉"] },
  { months: [8], key: "late_summer", label: "여름 마감·개학 전", tags: ["휴가", "여름마감", "개학전"] },
  { months: [9], key: "chuseok", label: "추석·가을", tags: ["추석", "한가위", "가을선물"] },
