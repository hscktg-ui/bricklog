...
export const BLOG_LENGTH_TIERS = {
  short: { min: 3600, max: 4400, target: 4000, label: "기본글" },
  medium: { min: 5600, max: 6400, target: 6000, label: "중간글" },
  long: { min: 7600, max: 10000, target: 8400, label: "긴글" },
};

/** V2 기본값 — 분량·품질 2× (2026-06 피드백 반영) */
export const BRICLOG_BASELINE_V2 = {
  lengthMultiplier: 2,
  qualityMultiplier: 2,
  humanMinSections: 6,
  giseungMinSections: 6,
  tierStructure: {
    short: { minSections: 8, minParagraphs: 12, maxParagraphs: 16 },
    medium: { minSections: 12, minParagraphs: 18, maxParagraphs: 24 },
    long: { minSections: 16, minParagraphs: 24, maxParagraphs: 30 },
  },
  humanBeliefMinScore: 85,
  experienceVoicePass: 80,
  explainPassRate: 0.92,
  experienceOpinionPassRate: 0.9,
  researchFactUtilizationRatio: 0.7,
  researchMinAnchored: { at6: 8, at3: 4, default: 2 },
  missionSectionGoal: { short: 6, medium: 8, long: 10 },
};
...
정보량 없이 글자수 맞추기 금지. tier: 기본 3600–4400 / 중간 5600–6400 / 긴 7600–10000. 미달·초과 재작성.
