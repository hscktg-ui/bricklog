  ...
  grocery: {
    ...
    slots: [
      ...
      { key: "grade", label: "등급", match: /특등|1등급|2등급|등급/ },
      {
        ...
        infer: (input) => (/햅쌀/.test(`${input.productName || ""}`) ? "햅쌀" : ""),
      },
  ...
  cafe: {
    ...
    slots: [
      ...
      },
      {
        ...
        infer: (input) =>
          /원두|블렌드|커피/.test(`${input.productName || ""}`) ? "원두" : "",
      },
