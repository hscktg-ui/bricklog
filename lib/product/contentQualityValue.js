...
import {
  ...
  scoreBrandProperNounAnchoring,
} from "@/lib/product/brandProperNounEngine";
...
export function computeContentQualityValue(pack, input = {}) {
  ...
  const brandSpecific = isBrandSpecificTopicInput(input)
    ? scoreBrandProperNounAnchoring(fullText, input)
    : null;
  ...
  return calibrateResearchHeavySqMinimum(bCalibrated, pack, input);
}
