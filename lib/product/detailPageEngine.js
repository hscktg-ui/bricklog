...
export function buildDetailPageFallbackPack(input = {}) {
  ...
  const byType = {
    ...
    intent: {
      ...
      body: `${intent}. ${brand} 그 질문에 광고 문장 대신 확인 가능한 기준으로 답합니다.`,
    },
    problem: {
      type: "intent",
      kicker: "왜 찾게 되나",
    ...
    explain: {
      ...
      body: `${product} 목록으로 외우는 상품이 아닙니다. ${explainLead}`,
    },
    usp: {
      type: "usp",
      kicker: "고르는 기준",
      title: "반복해서 확인하는 지점",
      bullets: feats.slice(0, 5),
    },
    observe: {
      type: "observe",
      kicker: "현장에서",
    ...
    brand: {
      ...
      body:
        n.brandDescription ||
        `${brand} ${n.productName}${eulReul(n.productName)} 크게 외치지 않고, 고르는 기준을 먼저 맞춰 둡니다.`,
    },
    notice: {
      type: "notice",
      kicker: "안내",
