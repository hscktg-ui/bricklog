...
const EXPERIENCE_OPINION_MARKERS = [
  {
    id: "observation",
    re: /느껴질|차이가|높은\s*편|쉬운\s*편|눈에\s*들어|눈에\s*띄|직접\s*확인|앉아\s*보면|한\s*다발|한\s*송이|비교해\s*보면|살보면|정리해\s*보면|들어가\s*보면/,
  },
  {
    id: "experience",
    re: /실제로|앉아\s*보면|앉아\s*보|직접|한\s*다발|한\s*송이|현장에서|쇼룸에서|맞춰\s*보면|이용해\s*보니|써\s*보니|다녀와\s*보니|받아\s*보니/,
  },
  {
    id: "opinion",
