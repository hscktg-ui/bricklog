/**
 * 브릭로그 상세 섹션 — 고를 때 막히는 점 → 설명 → 관찰 → 약한 안내
 */
export const DETAIL_PAGE_WIDTH = 860;
export const DETAIL_PAGE_EXPORT_WIDTHS = [860, 900, 1000, 1200];
...
export const DETAIL_PAGE_CORE_SECTION_IDS = Object.freeze([
  "hero",
  "intent",
  "explain",
  "observe",
...
export const DETAIL_PAGE_LENGTHS = {
  short: {
    id: "short",
    label: "짧게",
    sectionIds: ["hero", "intent", "observe", "spec", "cta"],
  },
  standard: {
    id: "standard",
    label: "표준",
    sectionIds: DETAIL_PAGE_CORE_SECTION_IDS,
  },
  long: {
    id: "long",
    label: "길게",
