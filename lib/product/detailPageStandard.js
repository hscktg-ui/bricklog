...
export function gptDetailPageSystemPrompt({ brandName, sectionIds, input = {} }) {
  return [
    "브릭로그 상세. 스마트스토어·쿠팡 상세 카피. GPT는 섹션 JSON만. 이미지는 그리지 않음.",
    ...
    "intent bullets는 고를 때 보는 순서(짧은 이름 2~4). usp bullets도 짧은 이름. 완전한 문장 금지.",
    "explain은 rows 두 칸: 막히는 점 / 먼저 볼 것. spec만 항목 표.",
    "패딩 문장 금지.",
