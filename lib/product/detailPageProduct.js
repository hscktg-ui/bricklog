...
export const DETAIL_PAGE_PRODUCT = {
  ...
  sub: "챗봇에 상세를 맡기면 글이 나옵니다. 브릭로그에 상품명을 넣으면 컷 사진과 860px 화면이 같이 나갑니다.",
  loginTitle: "내 상품은 로그인 후",
  loginHint: "아래는 포장 쌀 맛보기입니다. 상품명만 있어도 컷 사진을 만들어 붙입니다.",
  sampleCaption:
    "맛보기 · 여주 햅쌀 10kg · 컷별 상품 사진까지 붙인 860 화면",
  samplePath: "/detail/sample",
  sampleZoneId: "landing-detail-sample",
  generateLabel: "만들기",
  ctaLabel: "상세 만들기",
  emptyResult: "왼쪽을 채우고 만들면, 붙일 화면이 이쪽에 열립니다.",
  busyLine: "컷 사진과 고르는 화면을 맞추는 중…",
  ...
  pillars: [
    ...
    {
      title: "붙여넣기",
      desc: "스마트스토어·쿠팡 860px HTML을 각각 한 번에 복사합니다. 9개 몰 API는 쓰지 않습니다.",
    },
    {
      title: "나온 뒤 고치기",
