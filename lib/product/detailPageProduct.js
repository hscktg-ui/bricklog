...
export const DETAIL_PAGE_PRODUCT = {
  ...
  sub: "상세페이지는 이미지입니다. 상세 디자이너가 그 860 화면을 보고 난 뒤에 나갑니다.",
  loginTitle: "내 상품은 로그인 후",
  loginHint: "아래는 포장 쌀 맛보기입니다. 상세 디자이너가 본 이미지입니다.",
  sampleCaption:
    "맛보기 · 여주 햅쌀 10kg · 상세 디자이너가 본 860 이미지",
  ...
  metaDescription:
    "챗봇 글이 아니라 붙일 이미지입니다. 브릭로그에 상품명·사진을 넣으면 스마트스토어·쿠팡 860px 상세가 나갑니다. 상세 디자이너가 그 화면을 봅니다.",
  pillars: [
    {
      title: "막히는 점부터",
    ...
    {
      title: "넣은 것만",
      desc: "사진·강조 문구·꼭 넣을 내용만 남깁니다. 없는 후기·가격은 쓰지 않습니다. 사진은 올리면 먼저 쓰고, 빈 칸은 컷별로 생성합니다.",
    },
    {
      title: "붙여넣기",
      desc: "스마트스토어·쿠팡에 섹션 이미지를 위에서부터 올립니다. 리스트가 주는 것과 같이 통이미지입니다. 9개 몰 API는 쓰지 않습니다.",
    },
    {
      title: "나온 뒤 고치기",
