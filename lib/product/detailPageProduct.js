...
export const DETAIL_PAGE_PRODUCT = {
  ...
  versusUs: "골라보다는 붙일 화면을 줍니다.",
  sub: "챗봇에 상세를 맡기면 글이 나옵니다. 골라보다에 상품명·사진·강조를 넣으면 스마트스토어·쿠팡에 붙일 860px 화면이 나갑니다.",
  ...
  metaDescription:
    "챗봇 글이 아니라 붙일 화면입니다. 상품명·사진·강조 문구를 넣으면 스마트스토어·쿠팡 860px 상세가 나갑니다. 가짜 후기 없이, 고를 때 막히는 점부터 씁니다.",
  pillars: [
    {
      title: "막히는 점부터",
