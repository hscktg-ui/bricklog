  ...
  return {
    ...
    blogContent: {
      ...
      _meta: {
        ...
        softPass: !internalComplete,
        passOutput: internalComplete,
        postVerifySoft: !internalComplete,
        completeDraft: true,
        displayReady: true,
        internalQualityReady: internalComplete,
    ...
    meta: {
      ...(partial.meta || {}),
      v2PipelineVerified: internalComplete,
      passOutput: internalComplete,
      deliveryPreview: false,
      failReasons: reasons,
    },
