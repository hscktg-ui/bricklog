 ...
 * GPT-5.6 원고 위에 덮어씌워지는 「상담이 빨라집니다」「선택 기준이 달라졌어요」류.
 */
import { splitKoreanSentences } from "@/lib/content/v2AxisSentencePrune";
import { CHECKLIST_TEMPLATE_RES } from "@/lib/product/checklistVoiceConstants";
import { isChecklistInstructionSentence } from "@/lib/product/checklistVoiceEngine";
