...
import { isColumnistFastDeliveryEnabled, getColumnistFastMaxTokens, isCustomerTwoMinuteSlaMode } from "@/lib/config/briclogFastPipeline";
...
export async function generateColumnistSovereignPack(input = {}, opts = {}) {
  ...
  try {
    ...
    if (!columnistTierAccepts(parsed, input, { fast })) return null;
