...
import {
  BLOG_GENERATE_CTA,
  BLOG_GENERATE_CTA_BUSY,
  BLOG_GENERATE_CTA_QUOTED,
} from "@/lib/product/blogCtaCopy";
import { BRICLOG_MAIN_PROMISE } from "@/lib/product/channelHumanVoice";
...
export const WRITE_FLOW_STEPS = [
  ...
  { id: "region", label: "지역" },
  { id: "topic", label: "주제" },
  { id: "scene", label: "현장 한 줄" },
];

export const WORKSPACE_BLOG = {
  title: "브랜드 콘텐츠 작업실",
  resultTitle: "오늘의 원고",
  tagline: BRICLOG_MAIN_PROMISE,
  taglineCompact: "칼럼·공지·캡션 — 1~2분",
  cta: BLOG_GENERATE_CTA,
  ctaAlt: BLOG_GENERATE_CTA,
  ctaBusy: BLOG_GENERATE_CTA_BUSY,
  exampleCta: "30초 맛보기 — 예시로 바로 받기",
  exampleHint:
    "업종별 예시가 돌아갑니다. 글을 쌓으면 내 브랜드·주제로 채워 집니다.",
  generatingNote:
    "브랜드·주제를 맞춘 뒤 글을 받습니다. 보통 1분 안쪽. 완료될 때까지 새로고침은 피해 주세요.",
...
export const EMPTY_STORY = {
  title: "여기에 오늘의 원고가 채워집니다",
  body: `브랜드 · 지역 · 주제 — 세 칸만 채우고 ${BLOG_GENERATE_CTA_QUOTED}.`,
  hintCompact: "막히면 TIP을 펼쳐 보세요.",
  hint: "막히면 「작성 맥락 힌트」를 펼쳐 보세요.",
  hintMature: "주제만 바꿔 다시 받으세요.",
  historyCta: "지난 편집본",
  newStoryCta: "새 글 쓰기",
  footer: "완성되면 제목·본문 복사해 네이버 블로그에 붙이세요.",
};
...
export const MOBILE_STORY = {
  ...
  generatingNote: "① 맞춤 → ② 반영 → ③ 작성 → ④ 점검. 완성되면 「원고」로 전환됩니다.",
...
export const LOADING = {
  ...
  generationSub:
    "채널 담당자 톤으로 다듬는 중입니다. 보통 1~2분이면 편집본이 나옵니다. 화면을 닫지 마세요.",
  generationElapsed: (label) => `경과 ${label}`,
  generationRemaining: (label) => `예상 남은 시간 ${label}`,
  generationOverEstimate:
    "조사·점검 단계라 예상보다 길어질 수 있어요. 거의 다 됐습니다.",
  generationMobileWake:
    "모바일: 화면이 꺼지면 작성이 끊길 수 있어요. 잠시 화면을 켠 채로 두세요.",
};
...
export const RESULT_VIEW = {
  sectionLabel: "네이버 블로그 발행용",
  copyBlockTitle: "네이버에 붙여넣기",
  copyBlockTitleMobile: "붙여넣기",
  copyHint:
    "제목 칸 · 본문 칸 순서로 붙여 넣으세요. 소제목·문단 사이 빈 줄은 그대로 두세요.",
  copyHintMobile: "제목·본문 순서로 네이버 블로그 글쓰기에 붙여 넣으세요.",
  ...
  completeBannerBody:
    "제목·본문 복사 후 네이버 블로그 글쓰기에 붙여넣으면 됩니다.",
};
...
export const SERVICE_STATUS = {
  ...
  briefBody:
    "잠시 뒤 「조사 후 블로그 받기」를 다시 눌러 주세요. 계속되면 새로고침 후 재시도해 주세요.",
};
