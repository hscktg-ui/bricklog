...
export const WORKSPACE_BLOG = {
  ...
  generatingNote:
    "완성되면 오른쪽에 편집본이 표시됩니다. 새로고침·뒤로가기는 하지 마세요.",
...
export const LOADING = {
  ...
  generationSub: "조사·편집 — 약 1분. 화면을 닫지 마세요.",
...
export const RESULT_VIEW = {
  ...
  draftBannerTitle: "발행 전 확인용 초안",
  draftBannerBody:
    "아직 편집실에서 다듬는 중이에요. 내용을 확인한 뒤 「다시 받기」로 한 번 더 받거나 직접 수정해 주세요.",
  completeBannerTitle: "편집본이 준비됐어요",
  completeBannerBody: "복사해 네이버·인스타에 붙여 넣으면 됩니다.",
};
...
export const EMAIL_VERIFY = {
  title: "이메일 인증이 필요해요",
  body: "메일함(스팸 포함)의 링크를 누른 뒤 새로고침하세요. 그 전에는 글 받기가 잠시 멈춥니다.",
  resend: "인증 메일 다시 보내기",
};
