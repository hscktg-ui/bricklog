 ...
 * @param {object} [pack]
 */
export function resolveDeliveryTrustBadge(pack = {}) {
  ...
  if (
    ...
    return {
      ...
      hint: readiness.hint || DELIVERY_TRUST_PUBLISH.hint,
    };
  }
  ...
  if (readiness.status === "blocked" || grade.id === "C") {
    return {
      ...DELIVERY_TRUST_REFERENCE,
      hint: readiness.hint || DELIVERY_TRUST_REFERENCE.hint,
    };
  }

  return {
    ...DELIVERY_TRUST_POLISH,
    hint: readiness.hint || DELIVERY_TRUST_POLISH.hint,
  };
}
