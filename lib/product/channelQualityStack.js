...
function finishChannelPackLight(channel, pack, ctx = {}, finishFlags = {}) {
  ...
  const beliefAfter = scoreHumanBelief(getChannelFullText(next, channel), input, next);
  ...
  next = {
    ...
    _meta: {
      ...(next._meta || {}),
      humanBeliefScore: beliefAfter.score,
      humanBelief: beliefAfter.score >= (belief.score || 0) ? beliefAfter : belief,
