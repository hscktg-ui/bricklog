...
function heightFor(purpose) {
  if (purpose === "attention" || purpose === "closing") return 1200;
  if (purpose === "desire" || purpose === "experience") return 1400;
  if (purpose === "detail") return 1000;
  if (purpose === "comparison") return 900;
  if (purpose === "specification") return 1100;
  if (purpose === "problem") return 860;
  return 1000;
}
