...
export const DETAIL_PAGE_PHOTO_DIRECTION = {
  ...
  observe: { shot: "창으로 원물", hint: "포장 창·원물이 보이게. 손·모델 없음", height: 420, plate: "05", objectPosition: "50% 92%", zoom: 2.8 },
  feature: { shot: "라벨 한 점", hint: "같은 포장 글자가 읽히게. 다른 SKU로 바꾸지 않음", height: 340, plate: "06", objectPosition: "50% 30%", zoom: 2.2 },
