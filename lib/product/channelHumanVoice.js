...
const VOICES = {
  blog: {
    ...
    loadingSteps: [
      ...
      { sketch: "search", text: "조사·화자 반영 중…" },
      { sketch: "write", text: "칼럼니스트 톤으로 쓰는 중…" },
      { sketch: "check", text: "읽기 흐름 점검 중…" },
    ],
  ...
  place: {
    ...
    loadingSteps: [
      { sketch: "search", text: "매장·운영 정보 맞추는 중…" },
      { sketch: "place", text: "브랜드 담당자 공지 톤으로 쓰는 중…" },
      { sketch: "check", text: "방문·확인 포인트 점검 중…" },
    ],
  ...
  instagram: {
    ...
    loadingSteps: [
      { sketch: "search", text: "장면·브랜드 톤 맞추는 중…" },
      { sketch: "insta", text: "마케터 캡션 톤으로 쓰는 중…" },
      { sketch: "check", text: "줄바꿈·해시태그 점검 중…" },
    ],
...
const PIPELINE_STEPS = [
  ...
  { sketch: "write", text: "칼럼 톤 이야기 쓰는 중…" },
  { sketch: "place", text: "담당자·마케터 톤으로 맞추는 중…" },
  { sketch: "check", text: "채널별 점검 중…" },
];
