...
export const CHANNEL_PRODUCTS = {
  blog: {
    ...
    emptyTitle: "이야기 쓰기",
    emptyDesc:
      "네이버형 장문 이야기예요. 주제 · 키워드를 넣으면 검색에 맞게 글을 써 드립니다.",
  ...
  place: {
    ...
    startDesc:
      "이야기 글 없이도 공지·소식을 만들 수 있어요. 주제만 넣고 바로 생성하세요.",
  ...
  insta: {
    ...
    startDesc:
      "이야기 없이도 캡션·해시태그를 만들 수 있어요. 톤을 고른 뒤 바로 생성하세요.",
  ...
  image: {
    ...
    menuLabel: "프롬프트",
    shortLabel: "프롬프트",
    headerTitle: "비주얼 프롬프트",
    desc: "썸네일·카드용 문구만 (이미지 파일 생성은 별도)",
    icon: "image",
    emptyTitle: "비주얼 프롬프트",
    emptyDesc:
      "썸네일·카드용 프롬프트 문구예요. 완성 이미지 파일은 이 메뉴가 아닙니다.",
    startTitle: "프롬프트에서 바로 시작",
    startDesc:
      "주제·브랜드만으로도 비주얼 문구를 만들 수 있어요. 다른 채널 초안이 있으면 톤을 이어받습니다.",
    generateLabel: "프롬프트 만들기",
    deriveBlogLabel: "이야기에서 이어 만들기",
    deriveFromDraftLabel: "다른 채널 초안에서 이어 만들기",
    goBlogLabel: "이야기 탭에서 쓰기",
  },
...
export const WORKSPACE_MENU_SECTIONS = [
  {
    id: "create",
    label: "콘텐츠 만들기",
    menuIds: ["blog", "place", "insta", "image", "review"],
  },
  {
    id: "manage",
    label: "보관 · 운영",
...
export const SIMPLE_WORKSPACE_SECTIONS = [
  {
    id: "create",
    label: "콘텐츠 만들기",
    menuIds: ["blog", "place", "insta", "review"],
  },
  {
    id: "more",
    label: "더 보기",
    menuIds: ["image", "growth"],
  },
  {
    id: "manage",
    label: "기록",
...
export function channelHeaderTitle(menuId) {
  return CHANNEL_PRODUCTS[menuId]?.headerTitle || "BRICLOG";
}

export function channelShortLabel(menuId) {
  return CHANNEL_PRODUCTS[menuId]?.shortLabel || menuId;
}
