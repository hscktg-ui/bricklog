...
export const LANDING_GREETINGS_PUBLIC = [
  {
    ...
    sub: "브랜드와 지역, 오늘의 주제만 넣으면 이야기 · 플레이스 · 인스타가 한 톤으로 정리돼요. 상품은 브릭로그 상세에서 고르는 화면으로 따로 만듭니다.",
  },
  {
    id: "three",
    headline: "주제 하나로",
    headlineBreak: "채널까지",
    sub: "긴 이야기 · 한 줄 공지 · 인스타 캡션은 주제 하나로 맞춥니다. 상품은 브릭로그 상세에서 스마트스토어·쿠팡에 붙일 화면으로 짭니다.",
  },
  {
    id: "tone",
    headline: "우리 가게 말투로",
  ...
  },
  {
    ...
    headline: "쓰고, 고르고,",
    headlineBreak: "복사하기",
    sub: "네이버 · 플레이스 · 인스타에 붙일 문장을 나눠 드립니다. 상품 화면은 브릭로그 상세에서 HTML로 복사합니다.",
  },
  {
    id: "check",
    headline: "올리기 전에",
  ...
  },
  {
    ...
    headline: "샘플로 먼저",
    headlineBreak: "맞춰 보기",
    sub: "가입 없이 샘플을 확인할 수 있어요. 작업실을 만들면 브랜드 기록·운영 계획이 이어집니다.",
  },
  {
    id: "mobile",
    headline: "폰에서 쓰고",
