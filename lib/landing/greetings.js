...
export const LANDING_GREETINGS_PUBLIC = [
  {
    ...
    sub: "브랜드와 지역, 오늘의 주제만 넣으면 이야기 · 플레이스 · 인스타가 한 흐름으로 정리돼요.",
  },
  {
    id: "three",
    headline: "주제 하나로",
    headlineBreak: "채널까지",
    sub: "긴 이야기 · 한 줄 공지 · 인스타 캡션은 주제 하나로 맞추되 채널 말투는 섞이지 않게 나눕니다.",
  },
  {
    id: "tone",
    headline: "우리 가게 말투로",
  ...
  },
  {
    ...
    headline: "쓰고, 고르고,",
    headlineBreak: "복사하기",
    sub: "네이버 · 플레이스 · 인스타에 붙일 문장을 나눠 드립니다. 확인하고 바로 복사해 올리면 됩니다.",
  },
  {
    id: "check",
    headline: "올리기 전에",
