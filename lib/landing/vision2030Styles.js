/** Vision 2040 — Jobs one-scene · Cook density · hangul-safe tracking */
...
export const VISION_EYEBROW =
  "text-[11px] font-medium tracking-[0.04em] text-[var(--vision-muted)]";

export const VISION_HEADLINE =
  "text-[clamp(2rem,5.5vw,3.4rem)] font-semibold leading-[1.12] tracking-[-0.01em] text-[var(--vision-ink)]";

export const VISION_SUB =
  "text-[16px] leading-[1.65] text-[var(--vision-muted)] md:text-[18px]";

export const VISION_SECTION =
  "border-t border-[var(--vision-line)] bg-[var(--vision-paper)]";

export const VISION_SECTION_DARK =
  "briclog-vision-footer-cta border-t border-[var(--vision-line)] bg-[var(--vision-ink)] text-[var(--vision-paper)]";

export const VISION_PANEL =
  "overflow-hidden rounded-[1.35rem] border border-[var(--vision-line)] bg-[var(--vision-panel-bg,#fff)] shadow-[var(--vision-shadow-panel)]";

export const VISION_GLASS_CARD =
  "rounded-[1.25rem] border border-[var(--vision-line)] bg-[var(--vision-glass-strong)] shadow-[var(--vision-shadow-soft)] backdrop-blur-xl";

export const VISION_CTA_PRIMARY =
  "relative inline-flex min-h-[52px] w-full items-center justify-center rounded-full bg-[var(--vision-accent-deep,#03a94d)] px-8 text-[15px] font-semibold text-white shadow-[0_10px_32px_rgba(3,169,77,0.2)] transition hover:bg-[var(--vision-accent)] active:scale-[0.99] disabled:opacity-50 sm:w-auto";

export const VISION_CTA_ACCENT =
  "relative inline-flex min-h-[52px] w-full items-center justify-center rounded-full bg-[var(--vision-accent)] px-8 text-[15px] font-semibold text-white shadow-[0_10px_32px_rgba(3,199,90,0.28)] transition hover:brightness-105 active:scale-[0.99] disabled:opacity-50 sm:w-auto";

export const VISION_CTA_GHOST =
  "relative inline-flex min-h-[48px] w-full items-center justify-center rounded-full border border-[var(--vision-line-strong)] bg-[var(--vision-btn-ghost-bg,var(--vision-glass-strong))] px-7 text-[14px] font-semibold text-[var(--vision-ink)] shadow-[var(--vision-shadow-soft)] backdrop-blur-sm transition hover:bg-[var(--vision-btn-surface-hover,rgba(3,199,90,0.12))] active:scale-[0.99] sm:w-auto";

/** 요금·플랜 — accent outline pill */
export const VISION_CTA_OUTLINE =
  "relative inline-flex min-h-[48px] w-full items-center justify-center rounded-full border border-[var(--vision-accent-ring,rgba(3,199,90,0.35))] bg-[var(--vision-accent-soft,rgba(3,199,90,0.08))] px-7 text-[14px] font-semibold text-[var(--vision-accent-deep,#03a94d)] transition hover:border-[var(--vision-accent)] hover:bg-[var(--vision-accent-soft,rgba(3,199,90,0.12))] active:scale-[0.99] disabled:opacity-50 sm:w-auto";
...
export const VISION_MOBILE_SEGMENT_ACTIVE =
  "bg-[var(--vision-accent-deep,#03a94d)] text-white shadow-[0_4px_16px_rgba(3,169,77,0.24)] ring-1 ring-[var(--vision-accent-ring,rgba(3,199,90,0.3))]";
...
export const VISION_INPUT =
  "mt-2 w-full min-h-[50px] rounded-2xl border border-[var(--vision-line)] bg-[var(--vision-panel-bg,#fff)] px-4 text-[16px] text-[var(--vision-ink)] outline-none transition placeholder:text-[var(--vision-muted)] focus:border-[var(--vision-accent)] focus:ring-4 focus:ring-[var(--vision-accent-ring,rgba(3,199,90,0.12))]";
...
export const VISION_WORKSPACE_PANEL =
  "rounded-[1.15rem] border border-[var(--vision-line)] bg-[var(--vision-panel-bg,#fff)] shadow-[var(--vision-shadow-soft)]";
...
export const VISION_RESULT_HERO =
  "overflow-hidden rounded-[1.15rem] border border-[var(--vision-accent-ring,rgba(3,199,90,0.16))] bg-[linear-gradient(180deg,var(--vision-accent-soft,rgba(3,199,90,0.08))_0%,var(--vision-panel-bg,#fff)_48%)] shadow-[var(--vision-shadow-soft)]";

export const VISION_LOADING_PANEL =
  "overflow-hidden rounded-[1.25rem] border border-[var(--vision-line)] bg-[var(--vision-glass-strong)] shadow-[var(--vision-shadow-panel)] backdrop-blur-xl";
...
export const VISION_COPY_BTN =
  "briclog-pressable inline-flex min-h-[40px] items-center gap-1.5 rounded-full border border-[var(--vision-accent-ring,rgba(3,199,90,0.24))] bg-[var(--vision-btn-surface,rgba(3,199,90,0.09))] px-4 py-2 text-[13px] font-semibold text-[var(--vision-ink)] shadow-[var(--vision-shadow-soft)] transition hover:border-[var(--vision-accent)] hover:bg-[var(--vision-btn-surface-hover,rgba(3,199,90,0.14))] disabled:opacity-50";

export const VISION_GHOST_BTN =
  "briclog-pressable inline-flex min-h-[40px] items-center justify-center rounded-full border border-[var(--vision-line-strong)] bg-[var(--vision-btn-ghost-bg,rgba(3,199,90,0.06))] px-4 py-2 text-[12px] font-semibold text-[var(--vision-ink)] shadow-[var(--vision-shadow-soft)] transition hover:border-[var(--vision-accent-ring,rgba(3,199,90,0.3))] hover:bg-[var(--vision-btn-surface-hover,rgba(3,199,90,0.12))] disabled:opacity-50";

/** 인트로 하단 CTA — 단일 버튼(대기 중: 바로 보기 → 완료 후: 시작하기) */
export const VISION_INTRO_CTA =
  "relative z-20 inline-flex min-h-[52px] w-full max-w-[280px] items-center justify-center rounded-full bg-[var(--vision-accent)] px-8 text-[15px] font-semibold text-white shadow-[0_10px_32px_rgba(3,199,90,0.28)] transition hover:brightness-105 active:scale-[0.99] disabled:opacity-50 sm:max-w-none sm:min-w-[220px]";
...
export const VISION_STATUS_OK =
  "rounded-xl border border-[var(--vision-accent-ring,rgba(3,199,90,0.2))] bg-[var(--vision-accent-soft,rgba(3,199,90,0.08))]";
...
export const VISION_CHIP_ACTIVE =
  "border-[var(--vision-accent-ring,rgba(3,199,90,0.3))] bg-[var(--vision-accent-soft,rgba(3,199,90,0.09))] text-[var(--vision-ink)] ring-1 ring-[var(--vision-accent-ring,rgba(3,199,90,0.16))]";

export const VISION_CHIP_IDLE =
  "border-[var(--vision-line)] bg-[var(--vision-panel-bg,#fff)] text-[var(--vision-muted)] hover:border-[var(--vision-accent-ring,rgba(3,199,90,0.22))]";

export const VISION_FORM_FIELD =
  "w-full rounded-xl border border-[var(--vision-line)] bg-[var(--vision-panel-bg,#fff)] px-3 py-2.5 text-[14px] leading-relaxed text-[var(--vision-ink)] focus:border-[var(--vision-accent)] focus:outline-none focus:ring-4 focus:ring-[var(--vision-accent-ring,rgba(3,199,90,0.1))]";
...
export const VISION_TOOLBAR_BTN =
  "flex items-center gap-1.5 rounded-full border border-[var(--vision-line-strong)] bg-[var(--vision-btn-ghost-bg,rgba(3,199,90,0.06))] px-3 py-2 text-[12px] font-semibold text-[var(--vision-muted)] shadow-[var(--vision-shadow-soft)] hover:border-[var(--vision-accent-ring,rgba(3,199,90,0.28))] hover:text-[var(--vision-ink)] disabled:opacity-50";

export const VISION_TOOLBAR_BTN_ACCENT =
  "flex items-center gap-1.5 rounded-full border border-[var(--vision-accent-ring,rgba(3,199,90,0.28))] bg-[var(--vision-accent-soft,rgba(3,199,90,0.08))] px-3 py-2 text-[12px] font-semibold text-[var(--vision-ink)] hover:bg-[var(--vision-accent-soft,rgba(3,199,90,0.12))] disabled:opacity-50";

/** 텍스트 링크형 보조 행동 — Jobs: 버튼 경쟁 금지 */
export const VISION_TEXT_LINK =
  "inline-flex min-h-[44px] items-center justify-center px-2 text-[14px] font-medium text-[var(--vision-muted)] underline-offset-4 transition hover:text-[var(--vision-ink)] hover:underline";
