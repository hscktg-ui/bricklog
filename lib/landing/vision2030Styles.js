...
/** 인트로 우상단 Skip — 단일, 즉시 */
export const VISION_INTRO_SKIP =
  "absolute right-4 top-4 z-20 rounded-full px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-[var(--vision-muted)] transition hover:bg-[var(--vision-panel-bg,rgba(255,255,255,0.55))] hover:text-[var(--vision-ink)] sm:right-6 sm:top-6";
