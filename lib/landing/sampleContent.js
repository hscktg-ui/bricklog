 ...
 * 대표 4종 장문 샘플 — 접속마다 순환 (품질 점수는 내부용)
 */
...
export const LANDING_SAMPLE_SETS = FEATURED_SAMPLE_SEEDS.map(makeSample);
...
export const WHY_BRICLOG = [
  ...
  {
    title: "한 주제, 세 채널",
    desc: "이야기 한 번이면 플레이스 · 인스타까지 이어집니다. 필요하면 프롬프트 메뉴에서 비주얼 문구도 더할 수 있어요.",
  },
  {
    title: "게시 전에 다듬기",
    desc: "너무 길거나 어색한 표현을 미리 짚어 드려, 올리기 전에 마음이 편해집니다.",
  },
  {
    title: "기록이 남는 운영",
