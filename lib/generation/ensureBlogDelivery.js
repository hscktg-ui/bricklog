...
function finalizeBlogPackForUi(pack, input = {}) {
  ...
  return finalizeContentQualityForDelivery(next, enriched, "blog");
}
...
function hasCustomerVisibleBody(pack) {
...
function buildGuaranteedMissionDelivery(pipelineInput) {
  ...
  try {
    ...
    return {
      ...
      blogContent: finalizeRescuePackForUi(pack, pipelineInput),
      meta: {
