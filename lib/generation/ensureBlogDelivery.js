...
import { scrubSpeakerMismatchTitleOpening } from "@/lib/persona/speakerVoiceLock";
...
function finalizeBlogPackForUi(pack, input = {}) {
  ...
  const preserveVoice = isLlmHardPassPack(pack);
  ...
  next = scrubSpeakerMismatchTitleOpening(next, enriched);
