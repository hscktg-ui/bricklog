...
const MEMO_INTENT_MAP = [
  {
    re: /조사|자료|리서치|팩트|정보.*활용|반영.*부족|조사.*안/,
    intents: ["add_information_units", "weave_research_facts", "expand_explanations"],
    hint: "조사·팩트를 본문 문장에 자연스럽게 녹여",
  },
  {
    re: /짧|끊|이어지|생동|사람.*같|딱딱|건조|단절/,
    intents: ["humanize_prose", "expand_explanations", "add_examples"],
    hint: "문단 연결·현장감·사람 말투를 보강",
  },
  {
...
const TAG_INTENT_MAP = {
  ...
  low_info: ["add_information_units", "clarify_selection_criteria", "weave_research_facts"],
