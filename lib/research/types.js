...
/** 기본 조사 묶음 — 최신·지역·키워드·트렌드 (UI·파이프라인 SSOT) */
export const DEFAULT_RESEARCH_BUNDLE = ["latest", "local", "keyword", "trend"];

export const RESEARCH_TYPE_CORE_IDS = ["latest", "local"];
export const RESEARCH_TYPE_EXTRA_IDS = ["keyword", "trend", "competitor", "articles"];
...
export const DEFAULT_RESEARCH_INPUT = {
  ...
  researchTypes: DEFAULT_RESEARCH_BUNDLE,
  researchQuery: "",
};
