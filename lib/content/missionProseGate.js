...
export function ensureCustomerDeliveryBlogLength(pack, input = {}) {
  ...
  if ((best.sections?.length || 0) < sectionGoal) {
    best = ensureMinBlogSections(best, { input }, input, sectionGoal);
  ...
  if (isBriclogMissionEnforced() && !pack?._meta?.flowerRecommendationEditorial) {
