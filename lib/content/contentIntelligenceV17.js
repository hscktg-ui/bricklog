...
export const MASTER_ENGINE_V17_MULTI_AI_PIPELINE = [
  ...
  { id: "writer_ai", label: "Writer AI (GPT-5.6 Sol)", writes: true },
...
- Writer AI(GPT-5.6 Sol)는 조사·확장·메모리 병합 결과만으로 WRITE(완성본) 작성. 자체 조사 금지.
...
- Length Controller: 기본 3600–4400 / 중간 5600–6400 / 긴 7600–10000자. 미달·초과 재작성.
