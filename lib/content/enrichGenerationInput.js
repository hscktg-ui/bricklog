...
import { applyGenerationAxisAlignHints } from "@/lib/product/generationAxisAlignGate";
...
import { attachBrandDepthAuthoritativeBrief } from "@/lib/product/brandAuthoritativeBrief";
...
export function enrichInputForGeneration(input = {}) {
  ...
  base = sanitizeGenerationInputResearch(applyGenerationAxisAlignHints(base));
  ...
  out = attachBrandDepthAuthoritativeBrief(out);
  return out;
}
