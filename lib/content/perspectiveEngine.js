...
export function recommendContentPerspective(input = {}) {
  ...
  const contractPerspective = {
    product_guide: "informational",
    info_guide: "informational",
    info_compare: "comparison",
    info: "informational",
    visit_review: "review",
    brand_story: "brand",
    brand_philosophy: "brand",
    local_recommend: "customer",
    event_notice: "storytelling",
  };
  if (contractPerspective[contract.type]) {
    return contractPerspective[contract.type];
  }
