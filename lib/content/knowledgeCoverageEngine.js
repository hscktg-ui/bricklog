...
import { resolveResearchCategoryKey } from "@/lib/product/industryCategoryKey";
...
const CATEGORY_COVERAGE = {
  ...
  education: [
    { id: "brand", label: "학원", headingSuffix: "학원·운영 특징", keywords: ["학원", "브랜드"], group: "brand" },
    { id: "curriculum", label: "커리큘럼", headingSuffix: "커리큘럼·반 편성", keywords: ["커리큘럼", "반"], group: "product" },
    { id: "schedule", label: "일정", headingSuffix: "특강·등록 일정", keywords: ["특강", "등록", "일정"], group: "product" },
    { id: "target", label: "대상", headingSuffix: "대상 학년·목표", keywords: ["학년", "내신", "수능"], group: "product" },
    { id: "price", label: "비용", headingSuffix: "수강료·비용", keywords: ["비용", "수강료"], group: "purchase" },
    { id: "consult", label: "상담", headingSuffix: "상담·등록 절차", keywords: ["상담", "등록"], group: "visit" },
    { id: "compare", label: "비교", headingSuffix: "학원 비교 기준", keywords: ["비교", "기준"], group: "compare" },
    { id: "prep", label: "준비", headingSuffix: "등록 전 확인", keywords: ["준비", "확인"], group: "feature" },
    { id: "faq", label: "FAQ", headingSuffix: "자주 묻는 질문", keywords: ["FAQ", "질문"], group: "faq" },
  ],
  salon: [
    { id: "brand", label: "살롱", headingSuffix: "살롱·시술 특징", keywords: ["살롱", "미용실"], group: "brand" },
    { id: "menu", label: "메뉴", headingSuffix: "시술·메뉴 구성", keywords: ["염색", "펌", "메뉴"], group: "product" },
    { id: "consult", label: "상담", headingSuffix: "상담·두피 체크", keywords: ["상담", "두피"], group: "visit" },
    { id: "care", label: "관리", headingSuffix: "시술 후 관리", keywords: ["관리", "홈케어"], group: "feature" },
    { id: "price", label: "비용", headingSuffix: "비용·이벤트", keywords: ["비용", "이벤트"], group: "purchase" },
    { id: "reserve", label: "예약", headingSuffix: "예약·대기", keywords: ["예약", "대기"], group: "visit" },
    { id: "compare", label: "비교", headingSuffix: "컬러·시술 비교", keywords: ["비교", "톤"], group: "compare" },
    { id: "faq", label: "FAQ", headingSuffix: "자주 묻는 질문", keywords: ["FAQ"], group: "faq" },
  ],
  craft: [
    { id: "brand", label: "공방", headingSuffix: "공방·체험 소개", keywords: ["공방", "체험"], group: "brand" },
    { id: "class", label: "클래스", headingSuffix: "클래스·난이도", keywords: ["클래스", "난이도"], group: "product" },
    { id: "time", label: "소요", headingSuffix: "소요 시간·인원", keywords: ["소요", "시간"], group: "product" },
    { id: "prep", label: "준비", headingSuffix: "준비물·복장", keywords: ["준비물", "복장"], group: "feature" },
    { id: "price", label: "비용", headingSuffix: "예약금·비용", keywords: ["예약금", "비용"], group: "purchase" },
    { id: "finish", label: "완성", headingSuffix: "완성품·수령", keywords: ["완성품", "수령"], group: "ops" },
    { id: "compare", label: "비교", headingSuffix: "체험 비교 기준", keywords: ["비교", "선택"], group: "compare" },
    { id: "faq", label: "FAQ", headingSuffix: "자주 묻는 질문", keywords: ["FAQ"], group: "faq" },
  ],
  default: [
    { id: "brand", label: "브랜드", headingSuffix: "매장·안내", keywords: ["브랜드", "매장"], group: "brand" },
    { id: "offer", label: "서비스", headingSuffix: "서비스·구성", keywords: ["서비스", "구성"], group: "product" },
    { id: "feature", label: "특징", headingSuffix: "특징·차별", keywords: ["특징", "차별"], group: "feature" },
    { id: "price", label: "비용", headingSuffix: "비용·조건", keywords: ["비용", "가격"], group: "purchase" },
    { id: "promo", label: "혜택", headingSuffix: "혜택·행사", keywords: ["혜택", "할인"], group: "purchase" },
    { id: "process", label: "이용", headingSuffix: "이용·절차", keywords: ["이용", "절차"], group: "ops" },
    { id: "reserve", label: "예약", headingSuffix: "예약·문의", keywords: ["예약", "문의"], group: "visit" },
    { id: "visit", label: "방문", headingSuffix: "방문·동선", keywords: ["방문", "주차"], group: "visit" },
    { id: "prep", label: "준비", headingSuffix: "이용 전 확인", keywords: ["준비", "확인"], group: "feature" },
    ...
    { id: "hours", label: "운영", headingSuffix: "운영·휴무", keywords: ["운영", "시간"], group: "visit" },
    { id: "location", label: "위치", headingSuffix: "위치·주차", keywords: ["위치", "주차"], group: "visit" },
    { id: "faq", label: "FAQ", headingSuffix: "자주 묻는 질문", keywords: ["FAQ"], group: "faq" },
...
const AREA_INFO_BUILDERS = {
  ...
  curriculum: (p) => [
    `${p.brand} ${p.topicFacet || p.topic} 커리큘럼·반 편성은 학년·목표에 따라 달라집니다.`,
    `특강 기간·등록 마감·보강 규정은 상담실 안내를 기준으로 확인하세요.`,
    `내신·수능·특강 목표를 나눠 보면 필요한 반을 고르기 쉬워집니다.`,
  ],
  schedule: (p) => [
    `특강·방학 일정은 매년 바뀔 수 있어 공식 안내를 확인하세요.`,
    `등록·환불·보강 규정은 개강 전에 메모해 두면 편합니다.`,
    `${p.region ? `${p.region} ` : ""}통학·이동 시간도 함께 보면 좋습니다.`,
  ],
  target: (p) => [
    `대상 학년·선행 범위·목표 점수대를 상담 때 먼저 짚어 보세요.`,
    `소수정예·정규·특강 반 구성 차이를 비교해 보세요.`,
    `본인 목표와 맞지 않는 반은 과부하가 될 수 있습니다.`,
  ],
  menu: (p) => [
    `${p.topicFacet || p.topic} 메뉴·옵션은 두피 상태·원하는 스타일에 따라 달라집니다.`,
    `염색·펌·클리닉 패키지 구성을 나눠 보면 선택이 수월합니다.`,
    `시술 전 두피·모발 상태를 먼저 확인하는 편이 좋습니다.`,
  ],
  class: (p) => [
    `${p.brand} ${p.topicFacet || p.topic} 난이도·소요 시간은 클래스마다 다릅니다.`,
    `완성품 사진과 실제 작업 과정 설명을 함께 확인하세요.`,
    `예약 인원·취소 규정은 예약 전에 확인하는 편이 정확합니다.`,
  ],
  time: (p) => [
    `체험 소요 시간·대기·건조 시간까지 포함해 일정을 잡으세요.`,
    `주말·평일 클래스 시간대가 다를 수 있습니다.`,
    `동반 인원·어린이 참여 가능 여부도 함께 물어보세요.`,
  ],
  finish: (p) => [
    `완성품 수령 시점·포장·배송 가능 여부를 상담 때 확인하세요.`,
    `취소·변경 규정과 예약금 환불 조건을 메모해 두세요.`,
  ],
};
...
/** flavor 기반 동적 coverage — 카탈로그에 없는 업종·default 공통 */
function buildFlavorDrivenCoverageDefs(input = {}) {
  const { flavor } = getIndustryFlavorForInput(input);
  const label = String(flavor.label || "매장").trim();
  const product = String(flavor.productWord || "서비스·구성").trim();
  const productHead = product.split("·")[0].trim() || "서비스";
  return [
    { id: "brand", label: "브랜드", headingSuffix: `${label}·안내`, keywords: ["브랜드", label], group: "brand" },
    { id: "offer", label: "서비스", headingSuffix: `${productHead}·구성`, keywords: [productHead, "구성"], group: "product" },
    { id: "feature", label: "특징", headingSuffix: "특징·차별", keywords: ["특징", "차별"], group: "feature" },
    { id: "price", label: "비용", headingSuffix: "비용·조건", keywords: ["비용", "가격"], group: "purchase" },
    { id: "promo", label: "혜택", headingSuffix: "혜택·행사", keywords: ["혜택", "할인"], group: "purchase" },
    { id: "process", label: "이용", headingSuffix: "이용·절차", keywords: ["이용", "절차"], group: "ops" },
    ...
    { id: "location", label: "위치", headingSuffix: "위치·주차", keywords: ["위치", "주차"], group: "visit" },
    { id: "faq", label: "FAQ", headingSuffix: "자주 묻는 질문", keywords: ["FAQ", "질문"], group: "faq" },
    { id: "caution", label: "주의", headingSuffix: "주의·유의", keywords: ["주의"], group: "feature" },
  ];
}

/** 카탈로그·flavor SSOT — SaaS default 오염 방지 */
export function resolveCoverageDefs(input = {}) {
  const categoryKey = resolveResearchCategoryKey(input);
  const catalog = CATEGORY_COVERAGE[categoryKey];
  if (catalog) {
    return { categoryKey, defs: catalog };
  }
  return {
    categoryKey: categoryKey === "default" ? "local_business" : categoryKey,
    defs: buildFlavorDrivenCoverageDefs(input),
  };
}
...
export function buildKnowledgeCoverageMap(input = {}) {
  ...
  const { categoryKey, defs } = resolveCoverageDefs(input);
