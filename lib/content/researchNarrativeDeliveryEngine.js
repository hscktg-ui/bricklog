...
export function scoreResearchFactUtilization(pack, input = {}) {
  ...
  const minAnchored =
    total >= 6
      ? BRICLOG_BASELINE_V2.researchMinAnchored.at6
      : total >= 3
        ? BRICLOG_BASELINE_V2.researchMinAnchored.at3
        : BRICLOG_BASELINE_V2.researchMinAnchored.default;
  return {
    ok:
      anchored >= minAnchored ||
      ratio >= BRICLOG_BASELINE_V2.researchFactUtilizationRatio,
    anchored,
    total,
    ratio,
  };
