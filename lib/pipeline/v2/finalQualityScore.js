/**
 * STEP 11 — Final Quality Score (v6.2: 85 미만 재생성 · 95 발행)
 */
...
export function computeFinalQualityScore(pack, ctx = {}) {
  ...
  const needsRegen = total < REGEN_BELOW_SCORE;
  const publishReady = total >= REGEN_THRESHOLD;
  ...
  return {
    ...
    regenBelowScore: REGEN_BELOW_SCORE,
