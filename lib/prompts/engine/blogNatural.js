...
import { toMobileParagraphs, koreanObjectParticle, koreanSubjectParticle } from "./textUtils";
    ...
    return [
      {
        ...
        body: joinParagraphs([
          ...
          `${koreanObjectParticle(main)} 찾다 보면 영업 시간과 주차, 생화 상태를 함께 보게 됩니다.`,
          inc.includes("24시간")
      ...
      },
      {
        ...
        body: joinParagraphs([
          ...
          `${region}에서 ${koreanObjectParticle(main)} 검색해 오시는 분들은 주로 ‘늦은 시간 이용’과 ‘가격 비교’를 함께 보시는 것 같아요.`,
          subList[0]
      ...
      },
      {
        ...
        body: joinParagraphs([
          ...
          `${region} 근처에서 ${koreanObjectParticle(main)} 알아보신다면, 사진보다 실제 생화 상태를 확인해 보시는 걸 권합니다.`,
        ]),
      },
      {
  ...
  return [
    ...
    },
    {
      ...
      body: joinParagraphs([
        ...
        `${region}에서 ${koreanObjectParticle(main)} 알아보신다면, 영업 시간과 주차부터 확인해 보세요.`,
      ]),
    },
  ];
}
  ...
  return [
    {
      ...
      body: joinParagraphs([
        `${region}에서 ${koreanObjectParticle(main)} 검색하실 때, 위치와 진료 과목, 예약 방식부터 보시는 분이 많습니다.`,
    ...
    },
    {
      ...
      body: joinParagraphs([
        ...
        `${region}에서 ${koreanObjectParticle(main)} 비교하실 때는 ‘응대 톤’도 함께 보시면 도움이 됩니다.`,
      ]),
    },
    {
      heading: "재방문·관리",
  ...
  return [
    {
      ...
      body: joinParagraphs([
        `${koreanObjectParticle(region)} 지나다 ${koreanSubjectParticle(main)} 눈에 들어오는 경우가 많습니다.`,
    ...
    },
    {
      ...
      body: joinParagraphs([
        ...
        `${region}에서 ${koreanObjectParticle(main)} 비교하실 때는 ‘머무는 시간’ 기준으로 보시면 선택이 쉬워집니다.`,
      ]),
    },
    {
      heading: "방문 팁",
  ...
  return [
    {
      ...
      body: joinParagraphs([
        `${koreanObjectParticle(main)} 찾으시는 분들은 사진으로 보고 방문하는 경우가 많습니다.`,
    ...
    },
    {
      ...
      body: joinParagraphs([
        ...
        `${region}에서 ${koreanObjectParticle(main)} 알아보신다면 주차와 상담 예약 가능 여부부터 확인해 보세요.`,
      ]),
    },
  ];
}
  ...
  return [
    {
      ...
      body: joinParagraphs([
        `${region}에서 ${koreanObjectParticle(main)} 찾을 때는 위치와 이용 방식부터 보게 됩니다.`,
