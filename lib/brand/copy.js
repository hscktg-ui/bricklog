...
export const BRAND_META_DESCRIPTION =
  "브랜드·지역·주제로 이번 달 이야기·플레이스·인스타 운영을 맞춥니다. 세 채널이 같은 맥락으로 이어지되 각 채널의 톤은 분리해 제공합니다. 확인하고 복사해 올리세요. briclog.ai";
export const BRAND_META_DESCRIPTION_EN =
  "BRICLOG plans monthly blog, Smart Place, and Instagram copy from one topic while keeping each channel distinct and on-brand.";
...
export const BRAND_LATEST_UPDATE = {
  label: "2026년 8월 업데이트",
  headline: "전 기능 무료 · 블로그 · 플레이스 · 인스타 집중",
  bullets: [
    "스튜디오 전 기능 무료 개방",
