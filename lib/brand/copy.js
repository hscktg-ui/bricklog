...
export const BRAND_LATEST_UPDATE = {
  ...
  bullets: [
    "이야기 발행 후 플레이스·인스타 이어 만들기 — 이번 달 운영 리듬",
    "2026–27 네이버 AI Briefing·플레이스 연동 트렌드 반영",
...
export const LANDING_NAV_SIGNUP_CTA = "무료 가입";
export const LANDING_FOOTER_SIGNUP_CTA = "바로 가입하기";

/** 샘플 성공 후 고정 가입 유도 */
export const PUBLIC_TEST_STICKY_SIGNUP_HEADLINE =
  "이 브랜드 그대로 작업실에";
export const PUBLIC_TEST_STICKY_SIGNUP_CTA = "무료로 계속";
