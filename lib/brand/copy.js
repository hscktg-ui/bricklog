...
export const BRAND_META_TITLE = "BRICLOG";
export const BRAND_META_DESCRIPTION =
  "네이버 이야기 · 플레이스 · 인스타 글을 한곳에서 차곡 쌓는 브랜드 글쓰기.";
export const BRAND_META_KEYWORDS =
  "브릭로그, BRICLOG, 브랜드 글쓰기, 네이버 블로그, 네이버 플레이스, 인스타그램, SNS 마케팅, 콘텐츠 작성, 매장 홍보";
...
export const LANDING_CTA_FOOTNOTE =
  "무료 월 5회 · 플러스 19,900원/월 · 스튜디오 39,000원/월";

export const LANDING_HERO_DEFAULT = {
  headline: "주제 하나.",
  headlineBreak: "세 채널까지.",
  sub: "브랜드 · 지역 · 오늘의 한 줄만 넣으면 이야기·플레이스·인스타 초안이 차곡 쌓입니다.",
