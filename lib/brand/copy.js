...
export const BRAND_META_DESCRIPTION_EN =
  "BRICLOG is a live AI trend radar for founders, marketers, operators, and developers. Discover what is moving in AI, understand why it matters, and turn it into on-brand blog, Smart Place, and Instagram drafts.";
export const BRAND_META_KEYWORDS =
  "브릭로그, BRICLOG, briclog.ai, AI 트렌드, AI 도구, AI 모델, AI 검색, AI 뉴스, 브랜드 콘텐츠, 블로그 운영, 네이버 블로그, 스마트플레이스, 인스타그램, 지역 브랜드, 운영 계획, 발행 준비도, 콘텐츠 캘린더, AI trend radar, AI tools ranking, AI model ranking, AI trends today, founders, marketers, developers";
