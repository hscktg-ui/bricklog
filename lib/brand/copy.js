...
export const BRAND_VOICE = {
  ...
  freeHook:
    "지금은 전 기능 무료입니다. 샘플로 먼저 맞춰 보시고, 마음에 들면 작업실에서 이어가세요.",
};
...
export const BRAND_LATEST_UPDATE = {
  label: "2026년 7월 업데이트",
  headline: "전 기능 무료 · 맛보기에서 작업실로",
  bullets: [
    "스튜디오 전 기능 무료 개방",
    "맛보기 후 내 브랜드 그대로 이어가기",
...
export const PUBLIC_TEST_STICKY_SIGNUP_HEADLINE =
  "무료 · 이 브랜드 그대로";
export const PUBLIC_TEST_STICKY_SIGNUP_CTA = "무료로 이 브랜드 이어가기";
...
export const LANDING_HERO_DEFAULT = {
  ...
  sub: "브랜드·지역·주제만 넣으면 이번 달 블로그·플레이스·인스타가 한곳에서 정리됩니다.",
...
export const PUBLIC_TEST_HERO = {
  ...
  signupSave: "지금 무료입니다. 이 브랜드 그대로 작업실에서 이어가세요.",
  signupRecord: "방금 만든 글을 브랜드 기록으로 이을까요?",
  signupPhilosophy:
    "작업실에 이으면 브랜드 말투·지난 글이 이어집니다. 지금은 전 기능 무료입니다.",
};
