...
export const BRAND_VOICE = {
  metaphor:
    "오늘의 주제 하나로 이야기 · 플레이스 · 인스타 · 상품 상세가 차곡 쌓입니다.",
  promise:
...
export const BRAND_META_DESCRIPTION =
  "브랜드·지역·주제로 이번 달 운영 계획을 세우고, 조사·맥락 점검 후 이야기·플레이스·인스타 초안과 상품 상세 디자인을 받습니다. 확인하고 복사해 각 채널에 올리세요. briclog.ai";
...
export const LANDING_PRICING_SUB =
  "이야기 · 플레이스 · 인스타 · 상품 상세를 제한 없이 맞춰 보세요. 유료 플랜은 인사이트를 모은 뒤 순차 도입합니다.";
