...
export const BRAND_META_TITLE =
  "브릭로그 | AI 순위·랭킹 트렌드 보기 · 브랜드 콘텐츠";
export const BRAND_META_TITLE_SHORT = "BRICLOG";
export const BRAND_META_TITLE_KO = "브릭로그";
export const BRAND_META_DESCRIPTION =
  "AI 도구·모델 순위와 실시간 랭킹 트렌드를 보고, 왜 움직이는지 이해한 뒤 브랜드·지역·주제로 네이버 블로그·스마트플레이스·인스타 초안을 만듭니다. 구글·네이버 검색용 콘텐츠까지 한 흐름으로 준비하는 BRICLOG입니다.";
export const BRAND_META_DESCRIPTION_EN =
  "BRICLOG shows live AI tool and model rankings, explains why each trend is moving, and turns that into on-brand blog, Smart Place, and Instagram drafts for founders, marketers, and local operators.";
export const BRAND_META_KEYWORDS =
  "브릭로그, BRICLOG, briclog.ai, AI 순위, AI 랭킹, AI 트렌드, AI 트렌드 보기, AI 도구 순위, AI 모델 순위, AI 도구 랭킹, ChatGPT 순위, 제미니 순위, AI 검색, 네이버 AI 검색, 네이버 AI 브리핑, 구글 SEO, 네이버 SEO, 브랜드 콘텐츠, 네이버 블로그, 스마트플레이스, 인스타그램, 지역 브랜드, AI trend ranking, AI tools ranking, AI model ranking, AI trends today, founders, marketers, developers";

/** 검색·랜딩 SSR에 노출 — 최신 업데이트 한 줄 */
export const BRAND_LATEST_UPDATE = {
  label: "2026년 9월 업데이트",
  headline: "AI 순위·랭킹 트렌드 보기 · 전 기능 무료 · 블로그·플레이스·인스타 연결",
  bullets: [
    "AI 도구·모델 실시간 순위와 변동을 홈에서 확인",
    "구글·네이버 검색·AI 브리핑에 잡히기 쉬운 설명형 초안",
    "스튜디오 전 기능 무료 개방",
