...
export const QUICK_PROMPTS = [
  ...
  { id: "schedule", label: "운영 계획·스케줄", category: "create" },
...
export const QUICK_TEXT = {
  ...
  schedule: "이번 달·이번 주 운영 계획은 어디서 보나요?",
...
export function buildAssistantContext(ctx = {}) {
  ...
  const lines = [
    ...
    `운영 계획: 사이드바 「${CHANNEL_PRODUCTS.plan.menuLabel}」 — 이번 주·이번 달 주제·채널 리듬.`,
    ...
    `모바일: 하단 탭 ${formatMainChannelTabs()} + 더보기(운영 계획·작업실·기록·플랜)`,
    ...
    "발행 준비도: 브랜드·지역·주제·근거 축별 점수. 무료 테스트·작업실에서 확인.",
    "무료 테스트: 랜딩에서 발행 샘플 — 이야기·플레이스·인스타 미리보기 + 맥락 점수. 상품 화면은 briclog.ai/detail.",
