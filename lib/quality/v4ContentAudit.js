...
export const HUMANITY_MIN = 70;
export const SEARCH_INTENT_MIN = 50;

export const V4_PLACEHOLDER_RE =
  /\b(undefined|null|NaN|placeholder|TODO|FIXME|lorem)\b|좋은내용|브랜드명|지역명|업종명|제목|내용|입력값|예시|\[브랜드\]|\[지역\]|\[키워드\]/i;
...
export function scoreHumanity(pack, ctx = {}) {
  ...
  if (V4_PLACEHOLDER_RE.test(full)) {
    score -= 35;
