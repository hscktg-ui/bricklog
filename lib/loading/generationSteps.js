...
export const CUSTOMER_BLOG_UI_STEPS = [
  { sketch: "map", text: "브랜드·지역·주제 맞추는 중…" },
  { sketch: "search", text: "시의·화자·조사 반영 중…" },
  { sketch: "write", text: "사람 칼럼 톤으로 쓰는 중…" },
  { sketch: "check", text: "주제·반영도 점검 중…" },
];

/** 채널팩 — 한 조사에서 파생 */
export const CUSTOMER_PIPELINE_UI_STEPS = [
  { sketch: "search", text: "브랜드·주제 조사 중…" },
  { sketch: "write", text: "이야기 편집본 쓰는 중…" },
  { sketch: "place", text: "플레이스·인스타 맞추는 중…" },
  { sketch: "check", text: "올리기 전 점검 중…" },
];
