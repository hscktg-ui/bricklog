...
const ULTIMATE_STEPS = V4_PIPELINE_STEPS.slice(0, 4).concat([
  { icon: "✓", text: "최종 검수 중..." },
]);

const ULTIMATE_SENSITIVE_STEPS = V4_PIPELINE_STEPS.slice(0, 4)
  .concat([SENSITIVE_VERIFY_STEP])
  .concat([{ icon: "✓", text: "최종 검수 중..." }]);
