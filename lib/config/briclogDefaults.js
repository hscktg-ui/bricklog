...
export const BRICLOG_TIMING_DEFAULTS = Object.freeze({
  ...
  /** run 트리거 ack — 202 즉시 반환 */
  asyncRunTriggerTimeoutMs: 20_000,
  /** 블로그 생성 고객 체감 SLA */
...
export function getAsyncRunTriggerTimeoutMs() {
  return readEnvNumber(
    "BRICLOG_ASYNC_RUN_TRIGGER_TIMEOUT_MS",
    BRICLOG_TIMING_DEFAULTS.asyncRunTriggerTimeoutMs
  );
}
