...
export const PUBLIC_TEST_QUOTA_SIGNUP_SUB =
  "가입하면 방금 입력한 브랜드·주제 그대로 작업실에서 조사·글쓰기를 이어갈 수 있어요. 보통 2분이면 됩니다.";

export const PUBLIC_TEST_ERROR_SIGNUP_SUB =
  "가입 후에는 조사·재작성·세 채널 초안까지 한 번에 이어집니다. 테스트에 쓴 내용은 그대로 복원됩니다.";

export const PUBLIC_TEST_QUOTA_SIGNUP_CTA = "2분 가입 · 테스트 그대로 이어가기";

export const PUBLIC_TEST_ERROR_SIGNUP_CTA = "가입하고 전체 생성 이어가기";
...
export const PUBLIC_TEST_GATE_FAIL =
  "입력을 조금만 구체적으로 적어 주세요.\n브랜드 특징 한 줄(예: 수제 브런치·어버이날 픽업)을 주제에 넣거나, 위 「다른 예시 보기」로 가상 브랜드를 선택해 보세요.";
...
export const PUBLIC_TEST_BLUR_HINT =
  "아래는 발행 샘플 일부입니다. 전체 본문·복사·브랜드 기록은 가입 후 작업실에서 이어집니다.";
...
export const PUBLIC_TEST_TIME_HINT =
  "가상 브랜드 예시는 바로 확인됩니다. 직접 입력 시 보통 30~60초 걸립니다.";
