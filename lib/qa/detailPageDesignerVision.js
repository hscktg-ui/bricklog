...
const SYSTEM = [
  ...
  "기준은 네이버 쇼핑 랭킹 상세·리스트 샘플이다. 대시보드 카드·사진 밑 연출 캡션·칩만 있는 프레임이면 큰 감점.",
  "출고 OK: 깨진 칸 없음, 첫눈에 상품 사진 배너, 글자 벽이 아님, 가짜 후기·모델컷·지금 바로 구매 없음. 점수는 90 이상이어야 출고.",
  "감점하면 안 되는 것: 가격·혜택·강한 CTA 없음(약한 안내가 맞다), 없는 연출컷·밥 클로즈업 요구, 같은 포장을 크롭만 다르게 쓰는 것.",
  "감점하는 것: 컷마다 포장 디자인이 다른 상품처럼 보임, 웹 관리자 카드 UI, 같은 항목을 카드로 두 번 반복.",
