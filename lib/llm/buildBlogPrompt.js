...
User input overrides conflicting inference.${buildSensitiveSystemAddon(ctx.sensitiveCompliance)}${ctx.input?.evolutionLabBrief || getEvolutionPromptAddon(ctx.input || ctx)}`;
}
