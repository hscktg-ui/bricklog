 ...
 * Writer: GPT-5.6 Sol 고정 (조사·로컬·메모리 AI는 글 작성 금지 — V17)
 */
...
/** resolveWriterModel — 항상 gpt-5.6 (Sol) */
...
/**
 * GPT-5.6 Writer가 Mission prose·Editorial·템플릿 fallback 대신 전 구간 지배.
 * BRICLOG_GPT55_DOMINANT=false 로만 비활성. (env 키 호환 유지)
 */
...
export const isWriterModelDominant = isGpt55WriterDominant;
