...
export function buildDeliverableChannelFallback(
  ...
  if (channel === "place") {
    ...
    return {
      pack: markChannelDraft(pack, "place", "place_prose_fallback", failures),
      source: "place_prose_fallback",
    };
  }
  ...
  if (channel === "instagram") {
    ...
    if (!pack || !isPublishableChannelPack("instagram", pack)) {
      try {
        ...
        pack = buildProseInstagramPack(enriched, toneKey);
      }
    }
    ...
    return {
      ...
      source: "instagram_prose_fallback",
    };
  }
