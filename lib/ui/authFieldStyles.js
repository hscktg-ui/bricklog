...
export const AUTH_WARN_SURFACE_CLASS =
  "rounded-lg border border-[#FFE8CC] bg-[#FFF9F0] px-3 py-2 text-center text-[12px] leading-relaxed text-[#8B5A00]";

export const AUTH_ERROR_SURFACE_CLASS =
  "rounded-lg bg-[#FFF5F5] px-3 py-2 text-center text-[12px] text-[#E42939]";
