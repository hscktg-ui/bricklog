  ...
  return {
    ...
    hints: [
      ...
      publicBrandTest?.tableReady
        ? `맛보기 샘플 ${publicBrandTest.totalRuns ?? 0}건 · 순방문자 ~${publicBrandTest.totalSampleUsers ?? 0} · 랜딩 데모 ${publicBrandTest.landingDemoSharePct ?? 0}%`
        : "public_test_runs 미적용 — schema-v19-public-test.sql",
