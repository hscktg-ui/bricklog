...
const FAIL_REASON_HINTS = {
  ...
  first_delivery_human_belief:
    "첫 송출 belief 미달 — prodBeliefBoost·batchBeliefBoost 경로. rescue 후에도 CQ·editor 메타 확인.",
  first_delivery_human_editor:
    "humanEditorPass false — stampBatchBlogFirstDeliveryMeta·contentQualityDelivery 보강.",
  first_delivery_editor_v95:
    "editor v95 미통과 — applyEditorWriterDeliveryPass·editorWriterDeliveryPass 회귀.",
  first_delivery_persona:
    "페르소나 게이트 — syncSpeaker·personaEngine 정합성.",
  first_delivery_channel_editor:
    "채널 전문가 검수 미통과 — place/insta editor 패널.",
  first_delivery_channel_format:
    "채널 포맷(길이·구조) — channel format gate.",
  length_tier_under:
    "분량 tier 미달 — applyEditorWriterLengthPass·length tier 엔진.",
