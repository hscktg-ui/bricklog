  ...
  },
  {
    ...
    pack: {
      ...
      sections: [
        {
          heading: "장미와 수국",
          body: "여름에는 장미, 수국, 해바라기가 자주 찾습니다. 그랩앤고플라워는 파주 운정에서 24시간 무인으로 만원 꽃다발을 고를 수 있어 직접 보면 구성 차이가 눈에 들어옵니다.",
        },
        {
          heading: "튤립",
  ...
  },
  {
    ...
    pack: {
      ...
      sections: [
        {
          heading: "메뉴",
          body: "모닝브런치는 서울 강남에서 브런치와 원두 로스팅을 함께 즐길 수 있습니다. 테라스 좌석은 주말에 빨리 차서 직접 보면 분위기가 먼저 눈에 들어옵니다.",
        },
        {
          heading: "예약",
          body: "주말 브런치 메뉴는 11시 전에 방문하면 여유롭습니다. 실제로 가 보면 웨이팅이 덜합니다.",
        },
        {
          heading: "분위기",
