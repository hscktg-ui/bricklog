...
const u = assessUnifiedBlogDelivery(pack, input);
assert.equal(u.pass, true, "unified pass columnist A");
assert.equal(u.ok, true);

assert.equal(assessUnifiedBlogDelivery({ sections: [] }, input).pass, false, "empty pack fails");

console.log("OK unified-delivery-gate");
