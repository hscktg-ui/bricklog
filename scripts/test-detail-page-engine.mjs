...
assert.ok(html.includes('data-hero="plate"'));
...
assert.ok(html.includes("포장 앞면") || html.includes("data-photo-brief"));
assert.ok(html.includes("상품 사진") || html.includes("data-photo-direction"));
