...
function auditPack(pack, input) {
  ...
  return {
    ...
    writerEngine: Boolean(meta.briclogWriterEngine),
    writerRewritten: Boolean(meta.writerEngineRewritten || meta.llmHumanColumnRewrite),
    deliveryGrade: meta.deliveryGrade || null,
